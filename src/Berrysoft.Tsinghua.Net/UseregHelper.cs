...
namespace Berrysoft.Tsinghua.Net
{
    ...
    public class UseregHelper : NetHelperBase
    {
        ...
        private const string DetailUri = "https://usereg.tsinghua.edu.cn/user_detail_list.php?action=query&order=user_real_name&start_time={0}-{1}-01&end_time={0}-{1}-{2}&page={3}&offset=20";
